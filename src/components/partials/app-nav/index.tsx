...
interface extendedRoutesInterface
	extends ItitleLinks<IDropNavTitles, routePathTypes> {
	icons: JSX.Element;
}
...
const AppNav = () => {
	...
	const { authDetails, loggedIn, setAuthDetails, setLoggedIn, setCurrentUser } =
		...
		<>
			...
			>
				<div className=" hidden h-full w-full items-center justify-between bg-white  pt-2       md:flex md:px-container-base">
					<div className=" ">
						<img src={Logo} alt="logo" className="h-24 w-[10em]" />
					</div>
					<div className="relative max-w-[400px] md:w-full  ">
						<div className="rounded-[12px] bg-slate-100/60  px-[1.125rem] py-[0.175rem]  shadow-sm md:w-full">
							<div className="flex h-full w-full items-center">
								<Icon
									name="searchIcon"
									svgProp={{ className: "text-primary-9 w-4" }}
								/>
